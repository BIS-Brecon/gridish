...
impl Resolution {
    ...
    cfg_select! {
        ...
        _ => {
            pub(crate) fn representation(&self) -> (u32, u8) {
                match self {
                    Resolution::_100km => (_100KM, 0),
                    Resolution::_10km => (_10KM, 2),
                    Resolution::_1km => (_1KM, 4),
                    Resolution::_100m => (_100M, 6),
                    Resolution::_10m => (_10M, 8),
                    Resolution::_1m => (_1M, 10),
                }
            }
        }
    }
